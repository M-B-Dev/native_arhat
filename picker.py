...
.. code-block:: python
    ...
    def show_theme_picker(self):
        theme_dialog = ThemePicker()
        theme_dialog.open()

.. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/ThemePicker.gif
    :align: center
"""
...
class MDDatePicker(
    ...
    def fmt_lbl_date(self, year, month, day, orientation):
        if day == 31 and month in [9, 4, 6, 11]:
            day = 30
        elif int(day) > 28 and month == 2:
            day = 28 
...
<PrimaryColorSelector@ColorSelector>
    on_release: 
        getattr(app.root.ids.Tasks, self.parent.parent.parent.parent.parent.parent.parent.parent.parent.id).edit_task.content_cls.widg.color_picker(root.color_name)
